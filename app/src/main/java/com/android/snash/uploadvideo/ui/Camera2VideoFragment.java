...
public class Camera2VideoFragment extends Fragment
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        flash_img = view.findViewById(R.id.flash_img);
        flash_Rel = view.findViewById(R.id.flash_Rel);

        flash_Rel.setOnClickListener(new View.OnClickListener() {
            @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
            @Override
            public void onClick(View v) {
                ...
                if (mCurrentFlash == 1) {
                    ...
                    flash_img.setImageDrawable(getResources().getDrawable(R.drawable.ic_flash_on));
                    ...
                    //item.setTitle(FLASH_TITLES[mCurrentFlash]);
                    // item.setIcon(FLASH_ICONS[mCurrentFlash]);
                    flash_img.setImageDrawable(getResources().getDrawable(R.drawable.ic_flash_off));
                    if (mPreviewBuilder != null) {

                        updateFlash(FLASH_TORCH);
                        if (mPreviewSession != null) {
                            try {
                                mPreviewSession.setRepeatingRequest(mPreviewBuilder.build(), null, mBackgroundHandler);
                            } catch (CameraAccessException e) {
...
//         mButtonVideo.setText(R.string.record);
        tvVideo.setText(R.string.record);
        // Stop recording
        mMediaRecorder.stop();
